...
function App() {
  return (
    <div className="main p-0 m-0 box-border">
      <header className="bg-green-500 relative min-full">
        <nav className="absolute w-full p-4 md:p-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center justify-center text-2xl md:text-4xl text-white mb-4 md:mb-0">
              <img className="w-8 h-8 md:w-[43px] md:h-[43px]" src={Logo} alt="Comfy logo" />
              <h1 className="font-semibold ml-2">Comfy.</h1>
            </div>
            <ul className="flex invisible md:visible flex-wrap justify-center md:justify-around gap-8 md:gap-8 text-white font-semibold text-sm md:text-xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center h-full pt-24 md:pt-0">
          <div className="w-full md:w-[40%] text-center md:text-left p-12 md:pl-12 lg:pl-40">
            <h2 className="text-white text-3xl md:text-5xl lg:text-6xl font-medium mb-6 mx-8">Make your room comfy and beautiful.</h2>
          ...
          <img className="w-full object-cover  md:w-1/2 md:block md:h-screen mt-6 md:mt-0" src={HeroImage} alt="Comfortable room interior" />
        </div>
      </header>
      ...
      <section id="about" className="bg-white w-full py-8 md:py-12">
        <div className="flex flex-col md:flex-row justify-between p-4 md:p-12">
          <div className="md:w-1/2 p-4 md:p-8">
            <h3 className="font-semibold text-4xl md:text-6xl lg:text-8xl mb-6">About us</h3>
      ...
      <section id="shop" className="w-full py-8 md:py-12">
        <div className="p-4 md:p-8">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium font-poppins text-center md:text-left mb-8 md:pl-4 lg:pl-[7.5rem]">Shop</h1>
      ...
      <section id="contact" className="w-full py-8 md:py-12 px-4 md:px-0">
        <div className="w-full md:w-3/4 mx-auto bg-green-500 flex flex-col md:flex-row justify-between">
          <div className="p-4 w-full md:w-1/2 md:pt-16 lg:pt-24 md:px-8 lg:px-16">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium text-white font-poppins mb-8">Contact</h1>
          ...
          <img className="w-full md:w-1/2 hidden md:block object-cover" src={HeroImage} alt="Contact illustration" />
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row justify-between px-4 md:px-12 lg:px-20">
          <div className="mb-8 md:mb-0">
            <div className="flex items-center gap-2 mb-4">
              <img src={Logo} alt="Comfy logo" className="w-8 h-8 md:w-10 md:h-10" />
              <h1 className="font-semibold text-2xl md:text-3xl text-white">Comfy.</h1>
            </div>
            <p className="text-white text-opacity-50 text-sm md:text-base">@ComfyTM 2021</p>
          </div>
          <div className="flex flex-col gap-4 text-white font-poppins">
            <p className="text-base md:text-lg text-slate-300">Social Media</p>
            <a className="flex items-center text-sm md:text-base" href="#">Instagram <MdArrowOutward className="ml-2" /></a>
            <a className="flex items-center text-sm md:text-base" href="#">Facebook <MdArrowOutward className="ml-2" /></a>
            <a className="flex items-center text-sm md:text-base" href="#">Twitter <MdArrowOutward className="ml-2" /></a>
          </div>
        </div>
      </footer>
    </div>
